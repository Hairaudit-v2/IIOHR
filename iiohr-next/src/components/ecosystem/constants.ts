/**
 * Canonical node links for the Global Hair Intelligence Network.
 * Use across HLI, HairAudit, Follicle Intelligence, and IIOHR.
 */
import type { GlobalNetworkNodeId } from "./GlobalHairIntelligenceNetwork";

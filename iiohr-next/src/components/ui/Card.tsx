...
const quietBase =
  "min-w-0 rounded-xl border border-border/35 bg-surface/40 p-5 shadow-none md:p-6 md:p-7";
...
const quietInteractiveStyles =
  "transition-[border-color,background-color,transform] duration-200 ease-out hover:-translate-y-0.5 hover:scale-[1.005] hover:border-accent/28 hover:bg-surface/60";
